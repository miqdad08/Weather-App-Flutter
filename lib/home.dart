...
class _HomeState extends State<Home> {
  ...
  void fetchSearch(String input) async {
    try {
      ...
      setState(() {
        errorMessage = "Banyakin Istigfar";
      });
    }
  }
    ...
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(
            image: AssetImage('images/$weather.png'), fit: BoxFit.cover, colorFilter:
...
Widget forecastElement(daysFromNow, abbreviation, maxTemprature, minTemprature) {
